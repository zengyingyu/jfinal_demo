		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-quick-sidebar-toggler">
					<a href="<%=request.getContextPath()%>/logout" class="dropdown-toggle">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-slide-speed="200" data-auto-scroll="true" data-auto-scroll="true" data-slide-speed="200">
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a class="ajaxify" href="${pageContext.request.contextPath}/page/staff/add.jsp">新增员工 </a>
						</li>
						<li>
							<a class="ajaxify" href="${pageContext.request.contextPath}/page/staff/query.jsp">编辑员工 </a>
						</li>
						<li>
							<a class="ajaxify" href="${pageContext.request.contextPath}/page/cust/queryByStaff.jsp">按员工查客户</a>
						</li>
					</ul>
				</li>
				<li>
				...
				<li class="last">
					...
					<ul class="sub-menu">
						...
						<li>
							<a class="ajaxify" href="${pageContext.request.contextPath}/page/stats/stats_today_staff.jsp">今日按员工客户统计</a>
						</li>
					</ul>
				</li>
			</ul>
