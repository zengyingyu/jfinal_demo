	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-slide-speed="200" data-auto-scroll="true" data-auto-scroll="true" data-slide-speed="200">
				<li class="start">
					<a class="start" href="<%=request.getContextPath()%>/login.jsp" target="main">
				...
				<li>
					...
					<ul class="sub-menu">
						<li>
							<a href="layout_ajax_content_2.html">Ajax Link Sample 1 </a>
						</li>
						<li>
							<a href="layout_ajax_content_3.html">Ajax Link Sample 2 </a>
						</li>
						<li>
							<a href="layout_ajax_content_2.html">Ajax Link Sample 3 </a>
						</li>
						<li>
							<a href="layout_ajax_content_3.html">Ajax Link Sample 4 </a>
						</li>
					</ul>
				</li>
				<li>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<div class="page-content-body" style="height:100%;">
				<iframe name="main" width="100%" height="100%"  frameborder="0" marginheight="0" marginwidth="0" scrolling="auto"></iframe>
			</div>
		</div>
		<!-- BEGIN CONTENT -->
	</div>
